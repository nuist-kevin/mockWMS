...
public class ConfirmMsgSenderTest {
  ...
  public void testSender() throws JMSException, InterruptedException {
    ...
    new Thread(() -> {
      sendedMessage[0] = (ActiveMQTextMessage) jmsOperations.receive();
    }, "testThread").start();
      ...
      public Collection<JMXServiceURL> getJmxUrls() {
        ...
        try {
          jmxServiceURL = new JMXServiceURL(
              "service:jmx:rmi:///jndi/rmi://192.168.43.22:1099/jmxrmi");
...
//        }
  ...
  public void testJmx() throws Exception {
    ...
    ObjectName mbeanName = new ObjectName(
        "org.apache.activemq:brokerName=wms_CB_MQ,type=Broker,destinationType=Queue,destinationName=wms2OssService.synWmsOrderStatus");
    ...
    System.out.println(((CompositeDataSupport)
        mbsc.invoke(mbeanName, "getMessage",
            new Object[]{"ID:caiwen01-55556-1492412012540-1:2:1:1:1"},
